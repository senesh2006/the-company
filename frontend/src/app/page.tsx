    ...
    <div className="h-full flex flex-col relative">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6 shrink-0">
        <Card className="bg-zinc-950 border-zinc-800 p-4 flex flex-col justify-between h-24">
          ...
          <span className="text-2xl font-mono text-zinc-100">5</span>
        </Card>
        ...
        <Card className="bg-zinc-950 border-zinc-800 p-4 flex flex-col justify-between h-24">
          ...
          <span className="text-2xl font-mono text-emerald-400">2</span>
        </Card>

        <Card className="bg-zinc-950 border-emerald-900/50 bg-emerald-950/10 p-4 flex flex-col justify-between h-24">
          <div className="flex items-center gap-2 text-emerald-500">
            <ShieldAlert className="w-4 h-4" />
            <span className="text-xs font-mono">NEEDS ATTENTION</span>
          </div>
          <div className="flex justify-between items-end">
            <span className="text-2xl font-mono text-emerald-400">0</span>
            <span className="text-xs text-emerald-600 font-mono">ALL CLEAR</span>
          </div>
        </Card>
        ...
        <Card className="bg-zinc-950 border-zinc-800 p-4 flex flex-col justify-between h-24">
          ...
          <span className="text-2xl font-mono text-emerald-400">93.2%</span>
        </Card>
      </div>
      ...
      <div className="flex-1 bg-zinc-950/50 border border-zinc-800 rounded-lg overflow-auto relative">
        ...
        {viewMode === 'hierarchy' ? (
          isLoading ? <div className="p-8 text-zinc-500 font-mono">Connecting to swarm...</div> :
